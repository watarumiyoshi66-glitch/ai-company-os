...
**作成日：** 2026-05-11
**対象：** `/agents/specs/ai-employees.md`
**方針：** 各AI社員に2名の世界的著名人をロールモデルとして設定し、思考哲学・出力基準を再定義する。加えて、世界中の経営理論・営業理論・訴求術をグローバル知識武器庫として装備する
...
### アプローチ：複数ロールモデル融合型
各社員に英語圏と日本語圏から1名ずつロールモデルを設定し、それぞれの強みを掛け合わせる。
仕様書には「思考哲学（僕ならこう考える）」レベルまで反映する。
...
- `/agents/specs/ai-employees.md` — 本設計に基づき全面改訂
