...
| 仕組み | 用途 | 保存先 |
|---|---|---|
| Daily CEO Digest | オーナーが見る判断事項を1枚に圧縮 | `/reports/ceo-office/YYYY-MM-DD-ceo-digest.md` |
| AI社員 週次提案会議 | AI社員からの提案を集約し上位3件に絞る | `/reports/boardroom/YYYY-MM-DD-ai-employee-proposals.md` |
| X投稿 半自動パイプライン | 3案からCodexが1案を推奨 | `/content/x/drafts/` |
| Note候補 週次自動生成 | Note候補3本と推奨1本を作る | `/content/note/research/YYYY-MM-DD-weekly-note-candidates.md` |
| Services×GenAI 商品化レーダー | 有料Note・テンプレート・ソフトウェア仮説へ分類 | `/products/services-genai-weekly-monetization-map.md` |
