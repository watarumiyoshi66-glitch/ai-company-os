...
|---|---|---|
| 0 | 正常生成 | 不要 |
| 1 | テンプレート未発見 または ファイル重複 | エラーメッセージを確認してSection 4-A または 4-B へ |

### CCRルーティング設定（参照用）

| 項目 | 値 |
|---|---|
| ルーティングID | `trig_01SBKJ4ke5HJVyfeCivrRjJe` |
...
- このSOP自体の更新が必要な変更があれば `workflows/daily/daily-plan-sop.md` も更新する（通常はオーナーが判断。AI技術面の記述更新はClaude相談可）
